...
public class Demo {
    ...
    private void setAliOssProperties(AliOssProperties aliOssProperties) {
        Demo.aliOssProperties = aliOssProperties;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            PutObjectRequest putObjectRequest = new PutObjectRequest(bucketName, objectName, new FileInputStream("D:\\YYchainsaw\\Pictures\\Saved Pictures\\head.jpg"));
